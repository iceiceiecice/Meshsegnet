...
if __name__ == '__main__':
    ...
    model_path = './models'
    model_name = 'Mesh_Segementation_MeshSegNet_27_classes_205samples_u_test3_best_230epoch.tar'

    # mesh_path = './'  # need to modify
    # mesh_path = "C:\\Users\\xuzih\\Desktop\\valid_set\\kids\\u"
    # sample_filenames = ['202202220056_u.vtp', '202203150047_u.vtp', '202204030045_u.vtp', '202204070023_u.vtp', '202204090035_u.vtp', '202204100047_u.vtp', '202204140012_u.vtp', '202204150022_u.vtp', '202204150024_u.vtp', '202204160040_u.vtp', '202204170001_u.vtp', '202204170034_u.vtp', '202204170048_u.vtp', '202204180011_u.vtp', '202204180051_u.vtp', '202204180058_u.vtp', '202204190004_u.vtp']
    mesh_path = "C:\\Users\\xuzih\\Desktop\\valid_set\\normal\\u"
    sample_filenames = ['201910080029_u.vtp', '202109100015_u.vtp', '202202250055_u.vtp', '202203040023_u.vtp', '202203150038_u.vtp', '202203280005_u.vtp', '202203310017_u.vtp', '202204120004_u.vtp', '202204120026_u.vtp', '202204120038_u.vtp', '202204120041_u.vtp', '202204130025_u.vtp', '202204140020_u.vtp', '202204140032_u.vtp', '202204150020_u.vtp', '202204150021_u.vtp', '202204150026_u.vtp', '202204160034_u.vtp', '202204170015_u.vtp', '202204170060_u.vtp', '202204180007_u.vtp']
    # output_path = './outputs'
    output_path = './outputs_27_u_normal'
    ...
    with torch.no_grad():
        for i_sample in sample_filenames:
            ...
            print('\tDownsampling time: {0:.2f} sec'.format(mid_time_1 - start_time))
            ...
            print('\tPredicting time: {0:.2f} sec'.format(mid_time_2 - mid_time_1))
            ...
            print('\tRefining time: {0:.2f} sec'.format(mid_time_3 - mid_time_2))
            ...
            if upsampling_method == 'SVM':
                ...
                clf = SVC(kernel='rbf', gamma='auto', C=4.0)
                # train SVM
            ...
            vedo.write(mesh, os.path.join(output_path + '/final', '{}_predicted_refined.vtp'.format(i_sample[:-4])))

            mid_time_4 = time.time()
            print('Upsample completed')
            print('\tUpsampling time: {0:.2f} sec'.format(mid_time_4 - mid_time_3))
            ...
            print('\tTotal computing time: {0:.2f} sec'.format(end_time-start_time))
