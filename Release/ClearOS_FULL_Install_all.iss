...
#define MyAppVersion "4.5.7.2"
#define MyAppPublisher "ClearMed Corp. Copyright(c) 2022"
...
#define OutputFilename "ClearOS_FULL_ALL_V"

#define ClearCheckBin ".\ClearCheck-bin"
...
; clearcheck.exe rc
;资源文件，安装向导
Source: "{#ClearCheckBin}\Attachment\*"; DestDir: "{app}\bin\{#ClearCheckBin}\Attachment"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: {#ResourcesPath}; DestDir: {tmp}; Flags: dontcopy solidbreak ; Attribs: hidden system
Source: "{#ClearCheckBin}\publish_CN\icons\*"; DestDir: "{app}\bin\{#ClearCheckBin}\publish_CN\icons"; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: ".\Root\*"; DestDir: "{app}\bin\Root"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\Template\*"; DestDir: "{app}\bin\{#ClearCheckBin}\Template"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\ToothMoveDiff.cfg"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\platforms\*"; DestDir: "{app}\bin\{#ClearCheckBin}\platforms"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\imageformats\*"; DestDir: "{app}\bin\{#ClearCheckBin}\imageformats"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\pdf\*"; DestDir: "{app}\bin\{#ClearCheckBin}\pdf"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#ClearCheckBin}\Root\*"; DestDir: "{app}\bin\{#ClearCheckBin}\Root"; Flags: ignoreversion recursesubdirs createallsubdirs
; font
Source: "{#ClearCheckBin}\arial.ttf"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\default.ttf"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\msyhbd.ttf"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion

; text
Source: "{#ClearCheckBin}\server.xml"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ColorConfig.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ColorRenderGum.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ColorRenderJaw.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ColorRenderTooth.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
;Source: ".\log4cplus.properties"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ClearSample.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\error_file.ini"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion

; picture
Source: "{#ClearCheckBin}\bkg.bmp"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\gum.bmp"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\teeth.bmp"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\LVLogo.png"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\bkgClearCheck.bmp"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\GumImagebump.png"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\GumImageredwhite.png"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\pngofcreatemodify\*"; DestDir: "{app}\bin\{#ClearCheckBin}\pngofcreatemodify";

; exe
Source: "{#ClearCheckBin}\CBAutoUpdate.exe"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ClearCheck.exe"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ClearSample.exe"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion

;bat
;Source: ".\PMSort.bat"; DestDir: "{app}\bin"; Flags: ignoreversion

; dll
Source: "{#ClearCheckBin}\avcodec-56.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\avdevice-56.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\avfilter-5.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\avformat-56.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\avutil-54.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\CbKits.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\CbMathLib.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\CbNurbsLib.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\CbOrthoLib.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\CbRenderLib.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\glew32.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\LZMA.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\swresample-1.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\swscale-3.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\log4cplusU.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion                
Source: "{#ClearCheckBin}\CbArrayToothLib.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\log4cplusU.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\FreeImage.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\postproc-53.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5Core.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5Gui.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5Widgets.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5OpenGL.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\quazip.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5Svg.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\zlibwapi.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5Xml.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
;Source: ".\CbProduct.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "{#ClearCheckBin}\tinyxml2d.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\freetype.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\ucrtbased.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\vcruntime140d.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\Qt5PrintSupport.dll"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion

;qm文件
Source: "{#ClearCheckBin}\clearcheck_Chinese.qm"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\cbrenderlib_Chinese.qm"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\cbortholib_Chinese.qm"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
Source: "{#ClearCheckBin}\clearSample_Chinese.qm"; DestDir: "{app}\bin\{#ClearCheckBin}\"; Flags: ignoreversion
...
Root: "HKLM"; SubKey: "SOFTWARE\Classes\WebClearCheck"; ValueType: string; ValueName:"URL Protocol";ValueData: "{app}\bin\{#ClearCheckBin}\{#MyAppExeNameD} %l";Flags: CreateValueIfDoesntExist
...
Root: "HKLM"; SubKey: "SOFTWARE\Classes\WebClearCheck\Shell\open\command"; ValueType: string; ValueName:;ValueData: "{app}\bin\{#ClearCheckBin}\{#MyAppExeNameD} %l";Flags: CreateValueIfDoesntExist
...
Root: "HKCR"; Subkey: "CBM文件\shell\open\command"; ValueType: String; ValueData: """{app}\bin\{#ClearCheckBin}\{#MyAppExeNameD}"" ""%1"""; Flags: uninsdeletekey; Tasks: fileassoc
...
Root: "HKCR"; Subkey: "CBM文件\shell\OpenWithClearCheck\command"; ValueType: String; ValueData: """{app}\bin\{#ClearCheckBin}\ClearCheck.exe"" ""%1"""; Flags: uninsdeletekey; Tasks: fileassoc
;Root: "HKCR"; Subkey: "cmediafile//Shell//Open//Command"; ValueType: string; ValueName: ""; ValueData: "{app}/CMediaManager.exe %1"


Root: "HKCU"; Subkey: "SoftWare\Classes\CBM_auto_file\shell\open\command"; ValueType: string; ValueData: """{app}\bin\{#ClearCheckBin}\ClearCheck.exe"" ""%1"""; Flags: createvalueifdoesntexist uninsdeletekey; Tasks: fileassoc
Root: "HKCR"; Subkey: "Applications\{#MyAppName}\shell\open\command"; ValueType: string; ValueData: """{app}\bin\{#ClearCheckBin}\ClearCheck.exe"" ""%1"""; Flags: createvalueifdoesntexist uninsdeletekey; Tasks: fileassoc
...
Name: "{userdesktop}\可丽尔博士医生登录"; Filename: "https://drapp.boenkouqiang.com/clearsite"; IconFilename: "{app}\bin\publish\icons\{#MyOnlineICO}"
;Name: "{userdesktop}\离线登录";Filename: "{app}\bin\CBOfflineBrowser.exe"; IconFilename: "{app}\bin\publish\icons\{#MyOfflineICO}"
Name: "{userdesktop}\ERP登录"; Filename: "http://www.boenkouqiang.com/erp"; IconFilename: "{app}\bin\publish\icons\{#MyMedicineICO}"
Name: "{userdesktop}\可丽尔博士病例查看器"; Filename: "{app}\bin\{#ClearCheckBin}\ClearSample.exe"; IconFilename: "{app}\bin\{#ClearCheckBin}\publish_CN\icons\ClearCheck.ico"
