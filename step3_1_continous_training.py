...
if __name__ == '__main__':
    ...
    train_list = './train_list_6.csv'
    val_list = './val_list_6.csv'
    
    previous_check_point_path = './models'
    previous_check_point_name = 'latest_checkpoint.tar'
    
    model_path = './models/'
    model_name = 'Mesh_Segementation_MeshSegNet_27_classes_205samples_u_test2' #remember to include the project title (e.g., ALV)
